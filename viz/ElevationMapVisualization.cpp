...
osg::HeightField* ElevationMapVisualization::createHeighField()
{
    ...
    double offset_x = elev_map.getLocalFrame().translation().x();
    double offset_y = elev_map.getLocalFrame().translation().y();
    double offset_z = elev_map.getLocalFrame().translation().z();
